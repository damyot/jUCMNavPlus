...
public class ModelElementImpl extends EObjectImpl implements ModelElement {
	...
	protected EClass eStaticClass() {
		return UcmscenariosPackage.Literals.MODEL_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmscenariosPackage.MODEL_ELEMENT__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmscenariosPackage.MODEL_ELEMENT__NAME, oldName, name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmscenariosPackage.MODEL_ELEMENT__DESCRIPTION, oldDescription, description));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UcmscenariosPackage.MODEL_ELEMENT__ID:
				return getId();
			case UcmscenariosPackage.MODEL_ELEMENT__NAME:
				return getName();
