 ...
 * </p>
 * <ul>
 *   <li>{@link ucm.map.impl.FailurePointImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FailurePointImpl extends PathNodeImpl implements FailurePoint {
    ...
    public void setExpression(String newExpression) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapPackage.FAILURE_POINT__EXPRESSION, oldExpression, expression));
	}
