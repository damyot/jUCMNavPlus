...
public class NodeConnectionImpl extends MinimalEObjectImpl.Container implements NodeConnection {
	 ...
	 * @ordered
	 */
    protected EList outBindingsPlugin;
	 ...
	 * @ordered
	 */
    protected EList inBindingsPlugin;
	 ...
	 * @generated
	 */
    public EList getOutBindingsPlugin() {
		if (outBindingsPlugin == null) {
			outBindingsPlugin = new EObjectWithInverseResolvingEList(OutBinding.class, this, MapPackage.NODE_CONNECTION__OUT_BINDINGS_PLUGIN, MapPackage.OUT_BINDING__POINTCUT_ENTRY);
		}
	 ...
	 * @generated
	 */
    public EList getInBindingsPlugin() {
		if (inBindingsPlugin == null) {
			inBindingsPlugin = new EObjectWithInverseResolvingEList(InBinding.class, this, MapPackage.NODE_CONNECTION__IN_BINDINGS_PLUGIN, MapPackage.IN_BINDING__POINTCUT_EXIT);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case MapPackage.NODE_CONNECTION__OUT_BINDINGS_PLUGIN:
				...
				getOutBindingsPlugin().addAll((Collection)newValue);
				return;
			case MapPackage.NODE_CONNECTION__IN_BINDINGS_PLUGIN:
