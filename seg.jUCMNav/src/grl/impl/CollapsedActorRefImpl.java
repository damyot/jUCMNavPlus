 ...
 * </p>
 * <ul>
 *   <li>{@link grl.impl.CollapsedActorRefImpl#getActor <em>Actor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollapsedActorRefImpl extends GRLNodeImpl implements CollapsedActorRef {
	...
	protected EClass eStaticClass() {
		return GrlPackage.Literals.COLLAPSED_ACTOR_REF;
	}
		...
		if (actor != null && actor.eIsProxy()) {
			...
			if (actor != oldActor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, GrlPackage.COLLAPSED_ACTOR_REF__ACTOR, oldActor, actor));
			}
		}
		return actor;
	}
	...
	public NotificationChain basicSetActor(Actor newActor, NotificationChain msgs) {
		...
		actor = newActor;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GrlPackage.COLLAPSED_ACTOR_REF__ACTOR, oldActor, newActor);
	...
	public void setActor(Actor newActor) {
		if (newActor != actor) {
			...
			if (newActor != null)
				msgs = ((InternalEObject)newActor).eInverseAdd(this, GrlPackage.ACTOR__COLLAPSED_REFS, Actor.class, msgs);
			msgs = basicSetActor(newActor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GrlPackage.COLLAPSED_ACTOR_REF__ACTOR, newActor, newActor));
	}
