...
public class KpimodelPackageImpl extends EPackageImpl implements KpimodelPackage {
    ...
    public static KpimodelPackage init() {
		...
		Object registeredKpimodelPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		KpimodelPackageImpl theKpimodelPackage = registeredKpimodelPackage instanceof KpimodelPackageImpl ? (KpimodelPackageImpl)registeredKpimodelPackage : new KpimodelPackageImpl();
