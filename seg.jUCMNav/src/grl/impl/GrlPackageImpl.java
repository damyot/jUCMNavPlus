...
public class GrlPackageImpl extends EPackageImpl implements GrlPackage {
    ...
    public static GrlPackage init() {
		...
		Object registeredGrlPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GrlPackageImpl theGrlPackage = registeredGrlPackage instanceof GrlPackageImpl ? (GrlPackageImpl)registeredGrlPackage : new GrlPackageImpl();
