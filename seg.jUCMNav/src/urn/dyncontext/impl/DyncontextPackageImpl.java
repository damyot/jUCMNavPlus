...
public class DyncontextPackageImpl extends EPackageImpl implements DyncontextPackage {
	...
	public static DyncontextPackage init() {
		...
		Object registeredDyncontextPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DyncontextPackageImpl theDyncontextPackage = registeredDyncontextPackage instanceof DyncontextPackageImpl ? (DyncontextPackageImpl)registeredDyncontextPackage : new DyncontextPackageImpl();
