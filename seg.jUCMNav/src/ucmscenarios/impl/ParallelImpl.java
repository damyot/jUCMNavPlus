 ...
 * @generated
 */
public class ParallelImpl extends SequenceElementImpl implements Parallel {
	/**
	...
	protected EClass eStaticClass() {
		return UcmscenariosPackage.Literals.PARALLEL;
	}
	...
	public EList getChildren() {
		if (children == null) {
			children = new EObjectContainmentWithInverseEList(Sequence.class, this, UcmscenariosPackage.PARALLEL__CHILDREN, UcmscenariosPackage.SEQUENCE__PARENT);
		}
		return children;
	}
