...
public class UcmPackageImpl extends EPackageImpl implements UcmPackage {
    ...
    public static UcmPackage init() {
		...
		Object registeredUcmPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UcmPackageImpl theUcmPackage = registeredUcmPackage instanceof UcmPackageImpl ? (UcmPackageImpl)registeredUcmPackage : new UcmPackageImpl();
