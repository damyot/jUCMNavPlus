 ...
 * </p>
 * <ul>
 *   <li>{@link urn.dyncontext.impl.EnumChangeImpl#getNewValue <em>New Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumChangeImpl extends PropertyChangeImpl implements EnumChange {
	/**
	...
	protected EClass eStaticClass() {
		return DyncontextPackage.Literals.ENUM_CHANGE;
	}
	...
	public void setNewValue(String newNewValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DyncontextPackage.ENUM_CHANGE__NEW_VALUE, oldNewValue, newValue));
	}
