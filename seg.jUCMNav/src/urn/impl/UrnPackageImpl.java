...
public class UrnPackageImpl extends EPackageImpl implements UrnPackage {
    ...
    public static UrnPackage init() {
		...
		Object registeredUrnPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UrnPackageImpl theUrnPackage = registeredUrnPackage instanceof UrnPackageImpl ? (UrnPackageImpl)registeredUrnPackage : new UrnPackageImpl();
