...
public class UrncorePackageImpl extends EPackageImpl implements UrncorePackage {
    ...
    public static UrncorePackage init() {
		...
		Object registeredUrncorePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UrncorePackageImpl theUrncorePackage = registeredUrncorePackage instanceof UrncorePackageImpl ? (UrncorePackageImpl)registeredUrncorePackage : new UrncorePackageImpl();
