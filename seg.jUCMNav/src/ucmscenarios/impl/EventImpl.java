 ...
 * @generated
 */
public class EventImpl extends SequenceElementImpl implements Event {
	/**
	 ...
	 * @ordered
	 */
	protected static final EventType TYPE_EDEFAULT = EventType.START_POINT_LITERAL;
	...
	protected EClass eStaticClass() {
		return UcmscenariosPackage.Literals.EVENT;
	}
	...
	public void setType(EventType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmscenariosPackage.EVENT__TYPE, oldType, type));
	}
